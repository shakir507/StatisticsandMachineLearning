...
# Adjust the date range to match the smoothed data
...
# Plot testing data
plt.plot(date_range[train_size+look_back:train_size+test_size+look_back], data_smoothed[train_size+look_back:train_size+test_size+look_back], label='Testing Data')

# Plot predictions
prediction_dates = date_range[train_size+look_back:train_size+test_size+look_back]
